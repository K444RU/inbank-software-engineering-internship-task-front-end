<template>
  <div class="app-content d-flex flex-column min-vh-100">
    ...
    <main role="main">
      <main role="main">
        <div id="calculator" class="px-3 py-6 p-lg-12 bg-light-lavender">
          <div class="container calculator">
            <div class="row align-items-center">
              <div class="col-12 col-lg-6 pl-lg-6 pr-lg-12">
                <h2 class="h1 text-lg-center">Make your <i>loan application</i></h2>
              ...
              <div class="col-12 col-lg-6 calculator-title pl-lg-6">
                <div class="row no-gutters align-items-center">
                  <div class="col-12 px-0">
                    <div class="row d-flex flex-column-reverse flex-lg-row mb-8 mb-lg-7">
                      <div class="col-12 col-lg-4 mb-2 mb-lg-0">
                        <div class="i-input input-group has-selection">
                          <div><label for="" class="">
                            Personal code
                          </label>
